...
**Version 4.4.15** | [Modrinth](https://modrinth.com/project/Pb03qu6T) | [GitHub](https://github.com/SSoggy-Group/SSoggySouls-for-Hardcore)
...
Download the latest release (`SSoggySouls-4.4.15.jar`) from the [Releases page](https://github.com/SSoggy-Group/SSoggySouls-for-Hardcore/releases).

### Step 2: Install Plugin

Place `SSoggySouls-4.4.15.jar` in the `plugins/` folder of **both** servers:

- Main server: `/plugins/SSoggySouls-4.4.15.jar`

- Limbo server: `/plugins/SSoggySouls-4.4.15.jar`
...
**Full Changelog:** [v1...v4.4.15](https://github.com/SSoggy-Group/SSoggySouls-for-Hardcore/compare/v1...v4.4.15)
