...
public class LimboServerListener {
    ...
    private void registerDisconnectEvent() {
        ServerPlayConnectionEvents.DISCONNECT.register((handler, unusedServer) -> limboDeadPlayers.remove(handler.getPlayer().getUuid()));
    }
    ...
    private void registerWorldChangeEvent() {
        ServerEntityWorldChangeEvents.AFTER_PLAYER_CHANGE_WORLD.register((player, unusedOrigin, destination) -> {
