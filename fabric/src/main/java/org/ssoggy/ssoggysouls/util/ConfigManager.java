...
public class ConfigManager {
    ...
    public static class ModConfig {
        ...
        @Deprecated
        public void setSoulSandBlocktag(java.util.Collection<String> blocks) { setSoulSandBlockTag(blocks); }
        @Deprecated
        public void setFlowerBlocktag(java.util.Collection<String> blocks) { setFlowerBlockTag(blocks); }
        @Deprecated
        public void setOreBlocktag(java.util.Collection<String> blocks) { setOreBlockTag(blocks); }
        @Deprecated
        public void setFenceBlocktag(java.util.Collection<String> blocks) { setFenceBlockTag(blocks); }
        @Deprecated
        public void setStairBlocktag(java.util.Collection<String> blocks) { setStairBlockTag(blocks); }
