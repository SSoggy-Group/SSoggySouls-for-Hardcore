            ...
            .executes(context -> {
                context.getSource().sendError(MessageUtil.get("usage-revive").copy()
                    .styled(s -> s.withColor(net.minecraft.util.Formatting.RED)
                        ...
                        .withHoverEvent(new net.minecraft.text.HoverEvent(net.minecraft.text.HoverEvent.Action.SHOW_TEXT, MessageUtil.get(CLICK_AUTOFILL).copy().styled(h -> h.withColor(net.minecraft.util.Formatting.GRAY))))));
                return 0;
            })
            .then(CommandManager.argument(PLAYER, StringArgumentType.word())
                .suggests((context, builder) -> CommandSource.suggestMatching(
