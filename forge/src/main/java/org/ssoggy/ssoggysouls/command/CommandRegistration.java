...
public class CommandRegistration {
    ...
    private static void registerReviveCommand(CommandDispatcher<CommandSourceStack> dispatcher) {
        dispatcher.register(Commands.literal("revive")
            ...
            .executes(context -> {
                context.getSource().sendFailure(((net.minecraft.network.chat.MutableComponent) MessageUtil.get("usage-revive").copy())
                    .withStyle(s -> s.withColor(net.minecraft.ChatFormatting.RED)
                        ...
                        .withHoverEvent(new net.minecraft.network.chat.HoverEvent(net.minecraft.network.chat.HoverEvent.Action.SHOW_TEXT, ((net.minecraft.network.chat.MutableComponent) MessageUtil.get("click-to-autofill").copy()).withStyle(net.minecraft.ChatFormatting.GRAY)))));
                return 0;
            })
            .then(Commands.argument(PLAYER, StringArgumentType.word())
                .suggests((context, builder) -> SharedSuggestionProvider.suggest(
    ...
    private static void registerSetLivesCommand(CommandDispatcher<CommandSourceStack> dispatcher) {
        dispatcher.register(Commands.literal("psetlives")
            .requires(source -> source.hasPermission(2))
            .executes(context -> {
                context.getSource().sendFailure(((net.minecraft.network.chat.MutableComponent) MessageUtil.get("usage-psetlives").copy())
                    .withStyle(s -> s.withColor(net.minecraft.ChatFormatting.RED)
            ...
            .then(Commands.argument(PLAYER, StringArgumentType.word())
                ...
                .executes(context -> {
                    String targetName = StringArgumentType.getString(context, PLAYER);
                    context.getSource().sendFailure(((net.minecraft.network.chat.MutableComponent) MessageUtil.get("usage-psetlives-player", PLAYER, targetName).copy())
                        .withStyle(s -> s.withColor(net.minecraft.ChatFormatting.RED)
                                    ...
                                    for (String line : result.lines) {
                                        source.sendSystemMessage(Component.literal(line).withStyle(s ->
                                            s.withColor(net.minecraft.ChatFormatting.GRAY)
                                             ...
                                             .withHoverEvent(new net.minecraft.network.chat.HoverEvent(net.minecraft.network.chat.HoverEvent.Action.SHOW_TEXT, ((net.minecraft.network.chat.MutableComponent) Component.literal("Click to copy log entry").copy()).withStyle(net.minecraft.ChatFormatting.GRAY)))
                                        ));
                                    }
                                } else {
                                    for (String line : result.lines) {
                                        source.sendSystemMessage(((net.minecraft.network.chat.MutableComponent) Component.literal(line).copy()).withStyle(net.minecraft.ChatFormatting.GRAY));
                                    }
                                }
                            }
                        }
