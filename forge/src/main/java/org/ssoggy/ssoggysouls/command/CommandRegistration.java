...
public class CommandRegistration {
    ...
    private static net.minecraft.network.chat.Component createInteractiveUsage(String messageKey, String suggestCmd) {
        net.minecraft.network.chat.Component base = MessageUtil.get(messageKey);
        if (base == null) return net.minecraft.network.chat.Component.empty();
        net.minecraft.network.chat.Component hoverBase = MessageUtil.get("click-to-autofill");
        net.minecraft.network.chat.Component hover = hoverBase != null ? hoverBase.copy().withStyle(net.minecraft.ChatFormatting.GRAY) : net.minecraft.network.chat.Component.empty();

        return base.copy().withStyle(s -> s.withColor(net.minecraft.ChatFormatting.RED)
    ...
    private static void registerSetLivesCommand(CommandDispatcher<CommandSourceStack> dispatcher) {
        dispatcher.register(Commands.literal("psetlives")
            ...
            .then(Commands.argument(PLAYER, StringArgumentType.word())
                ...
                .executes(context -> {
                    String targetName = StringArgumentType.getString(context, PLAYER);
                    net.minecraft.network.chat.Component msg = MessageUtil.get("usage-psetlives-player", PLAYER, targetName);
                    if (msg != null) {
                        net.minecraft.network.chat.Component hoverBase = MessageUtil.get("click-to-autofill");
                        net.minecraft.network.chat.Component hover = hoverBase != null ? hoverBase.copy().withStyle(net.minecraft.ChatFormatting.GRAY) : net.minecraft.network.chat.Component.empty();
                        context.getSource().sendFailure(msg.copy().withStyle(s -> s.withColor(net.minecraft.ChatFormatting.RED)
